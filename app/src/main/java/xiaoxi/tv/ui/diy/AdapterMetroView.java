...
import xiaoxi.tv.tools.AnimationUtil;
...
//            mDrawable = getResources().getDrawable(R.drawable.shadow);
    ...
    protected void onFocusChanged(boolean gainFocus, int direction, Rect previouslyFocusedRect) {
        ...
        if (gainFocus) {
            ...
            getRootView().invalidate();
            if (hasAnim) {
                scaleAnimation = AnimationUtil.startScaleToBigAnimation(this, App.SCALE_RATE, new AnimatorListener() {
            ...
            if (hasAnim) {
                scaleAnimation = AnimationUtil.startScaleToSmallAnimation(this, App.SCALE_RATE, null);
            }
        }
    }
